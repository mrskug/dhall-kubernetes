...
, MatchResources =
    ./schemas/io.k8s.api.admissionregistration.v1alpha1.MatchResources.dhall
, NamedRuleWithOperations =
    ./schemas/io.k8s.api.admissionregistration.v1alpha1.NamedRuleWithOperations.dhall
, ParamKind =
    ./schemas/io.k8s.api.admissionregistration.v1alpha1.ParamKind.dhall
, ParamRef = ./schemas/io.k8s.api.admissionregistration.v1alpha1.ParamRef.dhall
, ValidatingAdmissionPolicy =
    ./schemas/io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicy.dhall
, ValidatingAdmissionPolicyBinding =
    ./schemas/io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicyBinding.dhall
, ValidatingAdmissionPolicyBindingList =
    ./schemas/io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicyBindingList.dhall
, ValidatingAdmissionPolicyBindingSpec =
    ./schemas/io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicyBindingSpec.dhall
, ValidatingAdmissionPolicyList =
    ./schemas/io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicyList.dhall
, ValidatingAdmissionPolicySpec =
    ./schemas/io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicySpec.dhall
, Validation =
    ./schemas/io.k8s.api.admissionregistration.v1alpha1.Validation.dhall
...
, StatefulSetOrdinals = ./schemas/io.k8s.api.apps.v1.StatefulSetOrdinals.dhall
...
, SelfSubjectReview =
    ./schemas/io.k8s.api.authentication.v1alpha1.SelfSubjectReview.dhall
, SelfSubjectReviewStatus =
    ./schemas/io.k8s.api.authentication.v1alpha1.SelfSubjectReviewStatus.dhall
...
, HPAScalingPolicy = ./schemas/io.k8s.api.autoscaling.v2.HPAScalingPolicy.dhall
, HPAScalingRules = ./schemas/io.k8s.api.autoscaling.v2.HPAScalingRules.dhall
...
, MetricIdentifier = ./schemas/io.k8s.api.autoscaling.v2.MetricIdentifier.dhall
, MetricSpec = ./schemas/io.k8s.api.autoscaling.v2.MetricSpec.dhall
, MetricStatus = ./schemas/io.k8s.api.autoscaling.v2.MetricStatus.dhall
, MetricTarget = ./schemas/io.k8s.api.autoscaling.v2.MetricTarget.dhall
, MetricValueStatus =
...
, PodsMetricSource = ./schemas/io.k8s.api.autoscaling.v2.PodsMetricSource.dhall
, PodsMetricStatus = ./schemas/io.k8s.api.autoscaling.v2.PodsMetricStatus.dhall
...
, PodFailurePolicy = ./schemas/io.k8s.api.batch.v1.PodFailurePolicy.dhall
...
, ClaimSource = ./schemas/io.k8s.api.core.v1.ClaimSource.dhall
...
, GRPCAction = ./schemas/io.k8s.api.core.v1.GRPCAction.dhall
...
, LifecycleHandler = ./schemas/io.k8s.api.core.v1.LifecycleHandler.dhall
...
, PodOS = ./schemas/io.k8s.api.core.v1.PodOS.dhall
, PodReadinessGate = ./schemas/io.k8s.api.core.v1.PodReadinessGate.dhall
, PodResourceClaim = ./schemas/io.k8s.api.core.v1.PodResourceClaim.dhall
, PodSchedulingGate = ./schemas/io.k8s.api.core.v1.PodSchedulingGate.dhall
...
, ResourceClaim = ./schemas/io.k8s.api.core.v1.ResourceClaim.dhall
...
, TypedObjectReference = ./schemas/io.k8s.api.core.v1.TypedObjectReference.dhall
...
, FlowDistinguisherMethod =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.FlowDistinguisherMethod.dhall
, FlowSchema = ./schemas/io.k8s.api.flowcontrol.v1beta3.FlowSchema.dhall
, FlowSchemaCondition =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.FlowSchemaCondition.dhall
, FlowSchemaList = ./schemas/io.k8s.api.flowcontrol.v1beta3.FlowSchemaList.dhall
, FlowSchemaSpec = ./schemas/io.k8s.api.flowcontrol.v1beta3.FlowSchemaSpec.dhall
, FlowSchemaStatus =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.FlowSchemaStatus.dhall
, GroupSubject = ./schemas/io.k8s.api.flowcontrol.v1beta3.GroupSubject.dhall
, LimitResponse = ./schemas/io.k8s.api.flowcontrol.v1beta3.LimitResponse.dhall
, LimitedPriorityLevelConfiguration =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration.dhall
, NonResourcePolicyRule =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.NonResourcePolicyRule.dhall
, PolicyRulesWithSubjects =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.PolicyRulesWithSubjects.dhall
, PriorityLevelConfiguration =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfiguration.dhall
, PriorityLevelConfigurationCondition =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfigurationCondition.dhall
, PriorityLevelConfigurationList =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfigurationList.dhall
, PriorityLevelConfigurationReference =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfigurationReference.dhall
, PriorityLevelConfigurationSpec =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfigurationSpec.dhall
, PriorityLevelConfigurationStatus =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfigurationStatus.dhall
, QueuingConfiguration =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.QueuingConfiguration.dhall
, ResourcePolicyRule =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.ResourcePolicyRule.dhall
, ServiceAccountSubject =
    ./schemas/io.k8s.api.flowcontrol.v1beta3.ServiceAccountSubject.dhall
, UserSubject = ./schemas/io.k8s.api.flowcontrol.v1beta3.UserSubject.dhall
...
, IngressPortStatus = ./schemas/io.k8s.api.networking.v1.IngressPortStatus.dhall
...
, NetworkPolicyStatus =
    ./schemas/io.k8s.api.networking.v1.NetworkPolicyStatus.dhall
, ServiceBackendPort =
    ./schemas/io.k8s.api.networking.v1.ServiceBackendPort.dhall
, ClusterCIDR = ./schemas/io.k8s.api.networking.v1alpha1.ClusterCIDR.dhall
, ClusterCIDRList =
    ./schemas/io.k8s.api.networking.v1alpha1.ClusterCIDRList.dhall
, ClusterCIDRSpec =
    ./schemas/io.k8s.api.networking.v1alpha1.ClusterCIDRSpec.dhall
...
, AllocationResult =
    ./schemas/io.k8s.api.resource.v1alpha1.AllocationResult.dhall
, PodScheduling = ./schemas/io.k8s.api.resource.v1alpha1.PodScheduling.dhall
, PodSchedulingList =
    ./schemas/io.k8s.api.resource.v1alpha1.PodSchedulingList.dhall
, PodSchedulingSpec =
    ./schemas/io.k8s.api.resource.v1alpha1.PodSchedulingSpec.dhall
, PodSchedulingStatus =
    ./schemas/io.k8s.api.resource.v1alpha1.PodSchedulingStatus.dhall
, ResourceClaimConsumerReference =
    ./schemas/io.k8s.api.resource.v1alpha1.ResourceClaimConsumerReference.dhall
, ResourceClaimList =
    ./schemas/io.k8s.api.resource.v1alpha1.ResourceClaimList.dhall
, ResourceClaimParametersReference =
    ./schemas/io.k8s.api.resource.v1alpha1.ResourceClaimParametersReference.dhall
, ResourceClaimSchedulingStatus =
    ./schemas/io.k8s.api.resource.v1alpha1.ResourceClaimSchedulingStatus.dhall
, ResourceClaimSpec =
    ./schemas/io.k8s.api.resource.v1alpha1.ResourceClaimSpec.dhall
, ResourceClaimStatus =
    ./schemas/io.k8s.api.resource.v1alpha1.ResourceClaimStatus.dhall
, ResourceClaimTemplate =
    ./schemas/io.k8s.api.resource.v1alpha1.ResourceClaimTemplate.dhall
, ResourceClaimTemplateList =
    ./schemas/io.k8s.api.resource.v1alpha1.ResourceClaimTemplateList.dhall
, ResourceClaimTemplateSpec =
    ./schemas/io.k8s.api.resource.v1alpha1.ResourceClaimTemplateSpec.dhall
, ResourceClass = ./schemas/io.k8s.api.resource.v1alpha1.ResourceClass.dhall
, ResourceClassList =
    ./schemas/io.k8s.api.resource.v1alpha1.ResourceClassList.dhall
, ResourceClassParametersReference =
    ./schemas/io.k8s.api.resource.v1alpha1.ResourceClassParametersReference.dhall
...
, CSIStorageCapacity = ./schemas/io.k8s.api.storage.v1.CSIStorageCapacity.dhall
